...
#include "type_adapt_example/image_pub_type_adapt_intra_node.hpp"
...
ImagePubTypeAdaptIntraNode::ImagePubTypeAdaptIntraNode(rclcpp::NodeOptions options)
...
ImagePubTypeAdaptIntraNode::~ImagePubTypeAdaptIntraNode()
{
}

}  // namespace type_adapt_example

RCLCPP_COMPONENTS_REGISTER_NODE(type_adapt_example::ImagePubTypeAdaptIntraNode)
